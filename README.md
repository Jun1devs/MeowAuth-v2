...
> **v2.0.2** — Complete rewrite with BCrypt security, automatic token authentication, and brute-force protection.
...
2. Download `MeowAuth-Server-2.0.2.jar` from [Releases](https://github.com/Jun1devs/MeowAuth-v2/releases)
...
1. Install **Minecraft Forge 1.20.1**
2. Download `MeowAuth-Client-2.0.2.jar` from [Releases](https://github.com/Jun1devs/MeowAuth-v2/releases)
...
| `/meowauth reset`  | Server   | Reset player token (admin, lvl 4)   |
...
| `tokenExpirySeconds`     | Token lifetime (0 = never)   | `0`                            |
...
> **v2.0.2** — Полная переработка: BCrypt-хеширование, автоматическая аутентификация токенами и защита от перебора.
...
2. Скачайте `MeowAuth-Server-2.0.2.jar` из [Releases](https://github.com/Jun1devs/MeowAuth-v2/releases)
...
1. Установите **Minecraft Forge 1.20.1**
2. Скачайте `MeowAuth-Client-2.0.2.jar` из [Releases](https://github.com/Jun1devs/MeowAuth-v2/releases)
...
| `/meowauth reset` | Сервер  | Сбросить токен игрока (admin, lvl 4) |
...
| `tokenExpirySeconds`     | Время жизни токена (0 = без)    | `0`                            |
